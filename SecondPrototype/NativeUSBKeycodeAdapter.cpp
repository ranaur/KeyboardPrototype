...
NativeUSBKeycodeAdapter::NativeUSBKeycodeAdapter() {
  static HIDSubDescriptor node(_hidReportDescriptor, sizeof(_hidReportDescriptor));
  HID().AppendDescriptor(&node);
}

void NativeUSBKeycodeAdapter::sendReport(KeyReport* keys)
{
...
size_t NativeUSBKeycodeAdapter::press(keycode_t k) 
{
...
size_t NativeUSBKeycodeAdapter::release(keycode_t k) 
{
  uint8_t modifier = getHIDModifier(k);
  _keyReport.modifiers &= ~(modifier);
